...
Tinytest.add('cfs-data - client - test environment', function(test) {
...
Tinytest.addAsync('cfs-data - client - Init with URL string', function(test, onComplete) {
  urlData = new FS.Data(Meteor.absoluteUrl('test'), "text/plain"); //'Hello World'
